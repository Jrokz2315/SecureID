...
B. For simplicity once Kudu launches add /new ui to the URL - https://myapp.scm.canadacentral-01.azurewebsites.net/newui this will launch the new UI with easier navigation.
